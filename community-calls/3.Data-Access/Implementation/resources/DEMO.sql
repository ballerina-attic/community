...
CREATE PROCEDURE `get_candidate_skill`(IN candidate_id INT, OUT skillCount INT)
BEGIN
	SELECT count(skill_id) INTO skillCount FROM candidate_skills where candidate_skills.candidate_id=candidate_id;
